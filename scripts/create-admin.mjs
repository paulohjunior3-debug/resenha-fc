...
//
// Senha padrão (se omitida): 1234 — mesma regra do cadastro normal de jogador.

import { createClient } from "@supabase/supabase-js";

const [, , nome, apelido, senha = "1234"] = process.argv;
...
console.log(`Admin criado com sucesso: ${apelido} (senha inicial: ${senha})`);
